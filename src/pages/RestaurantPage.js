          ...
          <Tabs variant="enclosed" onChange={(index) => setSelectedTab(index)}>
            ...
            >
              <Tab minW={{ base: "100px", md: "150px" }}>
                ...
                <HStack justify="center">
                  ...
                  />
                  <Text fontSize={{ base: "xs", md: "md" }}>Menu</Text>{" "}
                  {/* Smaller text on mobile */}
                </HStack>
              </Tab>
              <Tab minW={{ base: "100px", md: "150px" }}>
                <HStack justify="center">
                  <Icon as={FaListUl} boxSize={{ base: "0.8em", md: "1em" }} />
                  <Text fontSize={{ base: "xs", md: "md" }}>Combos</Text>
                </HStack>
              </Tab>
              <Tab minW={{ base: "100px", md: "150px" }}>
                <HStack justify="center">
                  <Icon
                    ...
                    boxSize={{ base: "0.8em", md: "1em" }}
                  />
                  <Text fontSize={{ base: "xs", md: "md" }}>Info</Text>
                </HStack>
              </Tab>
            </TabList>
            ...
            <TabPanels>
              <TabPanel p={{ base: 1, md: 4 }}>
                {" "}
                <Box
                  height={{ base: "calc(100vh - 360px)", md: "500px" }} // Adjusted height for mobile
                  overflowY="auto"
                >
